...
import {
  zhangjiajieAttractions,
  zhangjiajieItinerary,
  zhangjiajiePracticalInfo,
} from '../data/zhangjiajieAttractions'

export default function Zhangjiajie() {
  ...
  return (
    <div ref={fadeRef}>
      <HeroSection
        image={zhangjiajieAttractions[0].imageLarge}
        title="Zhangjiajie: Peaks Above the Clouds"
        subtitle="Sandstone pillars, glass skywalks, forest valleys, and mountain roads that feel unreal"
        overlay="bg-black/45"
      />
      ...
      <nav className="sticky top-16 md:top-20 z-30 bg-white/95 backdrop-blur-sm border-b border-gray-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex overflow-x-auto py-3 gap-2 scrollbar-hide">
            {zhangjiajieAttractions.map((attr) => (
              <a
                key={attr.id}
                href={`#${attr.id}`}
      ...
      <section className="py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 fade-in">
            <h2 className="section-title">Explore Zhangjiajie</h2>
            <p className="section-subtitle">
              Six dramatic experiences across Hunan's most cinematic mountain landscape
            </p>
          </div>

          <div className="space-y-16 md:space-y-24">
            {zhangjiajieAttractions.map((attraction, index) => (
              <div
                key={attraction.id}
                id={attraction.id}
      ...
      <section className="py-12 md:py-20 bg-warm-gray">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 fade-in">
            <h2 className="section-title">Suggested Route</h2>
            <p className="section-subtitle">
              A balanced four-day plan for the park, canyon, and Tianmen Mountain
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {zhangjiajieItinerary.map((item) => (
              <article key={item.day} className="bg-white rounded-2xl p-6 shadow-md card-hover fade-in">
                <p className="text-sm font-semibold text-china-red mb-2">{item.day}</p>
      ...
      <section className="py-12 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 fade-in">
            ...
            <p className="section-subtitle">
              Everything you need to plan your Zhangjiajie mountain adventure
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 fade-in">
            <div className="bg-white rounded-2xl p-6 shadow-md">
              ...
              <p className="text-gray-600 leading-relaxed">
                {zhangjiajiePracticalInfo.bestTimeToVisit}
              </p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-md">
              <h3 className="text-xl font-display font-bold text-deep-blue mb-3 flex items-center gap-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                {zhangjiajiePracticalInfo.gettingThere}
              </p>
            </div>
            <div className="bg-white rounded-2xl p-6 shadow-md">
              <h3 className="text-xl font-display font-bold text-deep-blue mb-3 flex items-center gap-2">
              ...
              <ul className="space-y-2">
                {zhangjiajiePracticalInfo.localTips.map((tip, i) => (
